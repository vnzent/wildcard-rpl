...
use App\Browser\Actions\CreateBrowser;
use App\Browser\Chrome;
use App\Models\Post;
            ...
            try {
                ...
                if (count($projectsList)) {
                    ...
                    try {
                        ...
                        Notification::make()
                            ->title(trans('cms.content.posts.import.behance.notifications.failed_title'))
                            ->body(trans('cms.content.posts.import.behance.notifications.failed_description'))
                            ->danger()
                            ->sendToDatabase($user);
                    }
                }
                ...
                $browser->driver->quit();
                Notification::make()
                    ->title(trans('cms.content.posts.import.behance.notifications.title'))
                    ->body(trans('cms.content.posts.import.behance.notifications.description', ['name' => $data['url']]))
                    ->success()
                    ->sendToDatabase($user);
