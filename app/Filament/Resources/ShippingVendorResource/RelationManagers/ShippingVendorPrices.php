...
class ShippingVendorPrices extends RelationManager
{
    ...
    {
        return trans('ecommerce.shipping_prices.single');
    }
    ...
    {
        return trans('ecommerce.shipping_prices.title');
    }
        ...
        return $form
            ->schema([
                Forms\Components\Select::make('type')
                    ->label(trans('ecommerce.shipping_prices.columns.type'))
                    ->searchable()
                    ->options([
                        'all' => trans('ecommerce.shipping_prices.columns.all'),
                        'delivery' => trans('ecommerce.shipping_prices.columns.delivery'),
                    ])
                    ->live()
                    ->default('all'),
                Forms\Components\Select::make('delivery_id')
                    ->label(trans('ecommerce.shipping_prices.columns.delivery_id'))
                    ->searchable()
