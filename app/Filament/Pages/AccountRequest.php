...
class AccountRequest extends Page implements HasForms, HasTable
{
    use InteractsWithForms;
    use InteractsWithTable;

    protected static string $view = 'pages.edit-requests';
    ...
    {
        return trans('account.account-requests.title');
    }
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ->query(\App\Models\AccountRequest::query()->where('account_id', auth('accounts')->user()->id))
            ->headerActions([
