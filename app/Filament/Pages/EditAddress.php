...
class EditAddress extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'pages.edit-address';
    ...
    {
        return trans('account.address.title');
    }

    public static function getNavigationLabel(): string
    {
        return trans('account.address.title'); // TODO: Change the autogenerated stub
    }
