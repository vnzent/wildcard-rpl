    ...
    public function handle(): void
    {
        ...
        if (isset($github['id'])) {
            ...
            if ($gitReadme) {
                ...
                Notification::make()
                    ->title(trans('cms.content.posts.import.github.notifications.title'))
                    ->body(trans('cms.content.posts.import.github.notifications.description', ['name' => $github['full_name']]))
                    ->success()
                    ->actions([
                        Action::make('view')
                            ->label(trans('cms.content.posts.import.github.notifications.view'))
        ...
        Notification::make()
            ->title(trans('cms.content.posts.import.github.notifications.failed_title'))
            ->body(trans('cms.content.posts.import.github.notifications.failed_description', ['name' => $repo]))
            ->danger()
            ->sendToDatabase($user);
    }
}
