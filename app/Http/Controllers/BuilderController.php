...
class BuilderController extends Controller
{
    ...
    public function builder(Request $request, Post $model): View|JsonResponse
    {
        $sections = FilamentCms::themes()->getSections()->groupBy('group');

        return view('filament-themes::pages.builder', compact('model', 'sections'));
    }

    public function meta(Request $request, Post $model)
    {
        $request->validate([
    ...
    public function metaStore(Request $request, Post $model)
    {
        $request->validate([
            'section' => 'required|string',
        ]);
    ...
    public function remove(Request $request, Post $model)
    {
        $request->validate([
            'section' => 'required|string',
        ]);
    ...
    public function sections(Request $request, Post $model)
    {
        $request->validate([
            'section' => 'required|string',
        ]);
    ...
    public function clear(Post $model)
    {
        $model->meta('sections', []);
